...
export const ManageArticles = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      console.error("Error details:", JSON.strigify(error, null, 2));
      toast.error(
  ...
  // seperate published and unpublished Articles
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                ...
                {publishedArticles.length > 0 && (
                  <span className="ml-3 w-6 h-6 flex items-center justify-center bg-green-100 border border-green-200 text-green-800 text-sm font-medium rounded-full">
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6">
            ...
            <div className="flex justify-end space-x-3">
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 cursor-pointer bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors duration-200">
                Cancel
              </button>
              ...
              <button
                ...
                disabled={isDeleting}
                className="px-4 py-2 cursor-pointer bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 flex items-center">
                {isDeleting ? (
                  <>
